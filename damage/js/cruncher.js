...
var CruncherCtrl = function($scope, $rootScope, $timeout) {
    ...
    var getBaseDamageForType = function(type) {
        ...
        for (var i=0;i<enabledEffects.length;++i) {
            ...
            if (enabledEffects[i].hasOwnProperty('atk'))
                result = applyCaptainEffectsToDamage(result,enabledEffects[i].atk,null,false,enabledEffects[i].sourceSlot,false);
        }
    ...
    var computeDamageOfUnit = function(unit, unitAtk, hitModifier, currentHitCount) {
        ...
        if ((staticBonusDamage > 0) && ((staticBonusDamage - currentDefense)>0) && (mapEffect.shieldLeft==0)) {
    ...
    var applyCaptainEffectsToDamage = function(damage,func,modifiers,isStatic,sourceSlot, isSailor) {
        return damage.map(function(x,n) {
            ...
            else if(!isSailor) x.multipliers.push([ func(params), 'efecto capitán' ]);
            else x.multipliers.push([ func(params), 'efecto sailor' ]);
    ...
    var initializeDataStructs = function() {
        ...
        $scope.tdata.team.forEach(function(x,n) {
            ...
            if (n < 2 && (id == 794 || id == 795 || id == 1191 || id == 1192 || id == 1219 || id == 1220 || id == 1361 || id == 1362 || id == 1588 || id == 1587 || id==1764))
