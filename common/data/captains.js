window.captains = {
    ...
    1361: {
        atk: function(p) { return  p.classCount.Slasher>=5 ? p.unit.class.has("Slasher") ? Math.max(2.5, 2.5 + .5 * Math.min(p.turnCounter,1)) : Math.max(1, 1 + .2 * Math.min(p.turnCounter,1)) : 1; },
    ...
    1557: {
        atk: function(p) {
            return p.unit.class.has("Striker") ? Math.max(1.0, 3 - 0.1 * p.turnCounter) : 1;
        }
    },
    1558: {
        atk: function(p) {
            return p.unit.class.has("Shooter") ? Math.max(1.0, 3 - 0.1 * p.turnCounter) : 1;
        }
    },
    1559: {
        atk: function(p) {
            return p.unit.class.has("Slasher") ? Math.max(1.0, 3 - 0.1 * p.turnCounter) : 1;
        }
    },
    1560: {
        atk: function(p) {
            return p.unit.class.has("Fighter") ? Math.max(1.0, 3 - 0.1 * p.turnCounter) : 1;
        }
    },
    1561: {
        atk: function(p) {
            return p.unit.type == "INT" ? Math.max(1.0, 3 - 0.1 * p.turnCounter) : 1;
        }
    },
    1562: {
        atk: function(p) {
         ...
         atk: function(p) {
            ...
            return p.slot==0 ? 6.25: 2.5;
             ...
             return p.slot==1 ? 6.25: 2.5;   
              ...
              return p.slot==0 && p.sourceSlot==0 || p.slot==1 && p.sourceSlot==1 ? 6.25: 2.5;  
            }else{
              return 2.5;
            }},
        hp: function(p) { return 1.3; },              
    ...
    1621: {
        atk: function(p) { return p.unit.class.has("Striker") && p.percHP <= 30.0 ? 3 : 2.5; },
        hp: function(p) { return p.unit.class.has("Striker") ? 1.2 : 1; }   
    },
     1622: {
        atk: function(p) { return p.unit.class.has("Slasher") ? 2 : 1; }
    ...
    1710: {
        atk: function(p) { return !p.unit.class.has("Cerebral") ? 1 : (((CrunchUtils.getOrbMultiplier(p.orb, p.unit.type, p.unit.class, 1, 2) == 2) && (p.orb != 'g')) ? 3 : 1.5); },
        rcv: function(p) { return p.unit.class.has("Cerebral") ? 1.2 : 1; }
    },
    1711: {
        atk: function(p) { return !p.unit.class.has("Cerebral") ? 1 : (((CrunchUtils.getOrbMultiplier(p.orb, p.unit.type, p.unit.class, 1, 2) == 2) && (p.orb != 'g')) ? 3 : 1.5); },
    ...
    1721: {
        atk: function(p) { return !p.unit.class.has("Fighter") ? 1 : (((CrunchUtils.getOrbMultiplier(p.orb, p.unit.type, p.unit.class, 1, 2) == 2) && (p.orb != 'g')) ? 3 : 1.5); },
        hp: function(p) { return p.unit.class.has("Fighter") ? 1.5 : 1; }
    },
    1722: {
        atk: function(p) { return p.unit.class.has("Powerhouse") ? 2 : 1; }
