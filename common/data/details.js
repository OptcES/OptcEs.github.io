window.details = {
	...
	1518: { 
        ...
        1587: {
                ...
                captainAction:"Sanji se eleva en el aire durante un turno haciéndose inmune a diferentes estados negativos y preventivos del enemigo, al siguiente turno el Sanji que ha saltado aumenta SU propio ATK un x2.5 más durante un turno",
                captainActionNotes:"'Captain action' es una nueva mecánica que se activa cuando deslizas el dedo hacia abajo en el icono del Capitán (Como si lanzaras un Especial pero al revés), añade efectos extra al personaje mientras sea Capitán",
	...
	1593: {
        ...
        specialNotes:"Sobre-sanación se refiere a la cantidad de HP curada a partir de la vida máxima. El contador de sobre-sanación empieza a contar desde que se empieza la batalla o desde que algún Enel Legend active su especial",
        specialName: "Heavy Thunder",
        },
        1610: {
        captain: "Reduce el HP máxima del equipo un 20%. Aumenta el ATK dependiendo del HP recuperada en el anterior turno (3.25x como máximo y un 2x como mínimo). Aumenta la aparicion de orbes [RCV] y estos contarán como orbes Favorables.",
        captainNotes: "Cuanto más alta sea esta cantidad de sanación, mayor será el multiplicador de ATK. 1000 de sanación equivale a 2.1x, 7000 sobre 3x y 10000 a 3.25x",
        special: "Hace daño sin tipo a todos los enemigos equivalente a 10x de la cantidad de sobre-sanación total entre todos los turnos anteriores, con un máximo de 2.000.000 de daño",
        specialNotes:"Sobre-sanación se refiere a la cantidad de HP curada a partir de la vida máxima. El contador de sobre-sanación empieza a contar desde que se empieza la batalla o desde que algún Enel Legend active su especial",
        specialName: "Heavy Thunder",       
        },
        1611: {
        ...
        1615: {
        captain: "Aumenta el ATK de los personajes Striker 2x",
        special: "Hace un daño equivalente a su ATK 20x a todos los enemigos. Reduce la carga de los especiales de los personajes Striker 1 turno. Aumenta el ATK y la efectividad de los orbes de los personajes Striker 1.5x durante un turno",
        sailor: "Cuando retrasan su especial recupera 2 turnos de su carga de especial",
        ...
        1617: {
        captain: "Aumenta el ATK de los personajes [STR], [DEX] e [INT] 2x",
        ...
        sailor: "Reduce la carga del especial de esta unidad si´esta mata a una unidad",
        ...
        1619: {
        captain: "Aumenta el multiplicador de cadena 4x. Aumenta el HP y el RCV de todos los personajes 1.2x",
	...
	1647: { 
        ...
        1683: {
            ...
            special: "Se encadena a si misma durante 1 turno, vacia todos los orbes [NEGATIVO] hade daño severo a un solo enemigo y aumenta el ATK sobre los enemigos con defensa reducida 1.5x dura<nte 2 turnos",
        ...
        1703: {//Hannyabal
            captain: "Aumenta el ATK de los personajes [INT] 2x",
            special: "Reduce el daño recibido un 50% durante 2 turnos y aumenta el ATK contra los enemigos envenenados 1.75x durante 2 turnos",
            specialName: "Inferno Hell Wheel",
            sailor: "Cuenta los orbes [STR], [QCK], [DEX], [PSY] y [INT] como favorables para esta unidad si el Capitán es Striker",
        },
        1704: {//Hannyabal
            captain: "Aumenta el ATK de los personajes [INT] 2.5x, recupera una cantidad equivalente de HP a su RCV 2x al final de cada turno",
            special: "Reduce el daño recibido un 50% durante 2 turnos y aumenta el ATK contra los enemigos envenenados 1.75x durante 2 turnos",
            specialName: "Inferno Hell Wheel",
            sailor: "Cuenta los orbes [STR], [QCK], [DEX], [PSY] y [INT] como favorables para esta unidad si el Capitán es Striker",
        },
        1705: {//Bon Clay
            captain: "Aumenta el ATK de los personajes [STR] 2x",
            special: "Elimina todos los buffs aliados. Sobrevives a cualquier golpe si la HP del equipo se encuentra por encima del 50%",
            specialName: "A Speech Left in Hell",
            sailor: "Aumenta HP, RCV, y ATK de todos los personajes en 50 puntos",
        },
        1706: {//Bon Clay
            captain: "Aumenta el ATK de los personajes [STR] 2.5x. Aumenta el ATK de los personajes [STR] 3.125x tras hacer 3 Perfects seguidos",
            special: "Elimina todos los buffs aliados. Sobrevives a cualquier golpe si la HP del equipo se encuentra por encima del 50%",
            specialName: "A Speech Left in Hell",
            sailor: "Aumenta HP, RCV, y ATK de todos los personajes en 50 puntos",
        },
        ...
        1708: {//Summer Nami
            captain: "Recupera una cantidad equivalente de HP a su RCV 3x al final de cada turno",
            special: "Reduce la carga de los especiales de personajes Striker y Cerebral 1 turno, reduce la duración de la Parálisis 2 turnos, aleatoriza los orbes no favorables",
            specialName: "Cat Burglar's Eye Contact",
            sailor: "Cuenta orbes [TND] como favorables para esta unidad",
        },
        1709: {//Summer Nami
            captain: "Aumenta el ATK de todos los personajes 1.5x, Recupera una cantidad equivalente de HP a su RCV 4x al final de cada turno",
            special: "Reduce la carga de los especiales de personajes Striker y Cerebral 1 turno, reduce la duración de la Parálisis 2 turnos, aleatoriza los orbes no favorables",
            specialName: "Cat Burglar's Eye Contact",
            sailor: "Cuenta orbes [TND] como favorables para esta unidad",
        },
        1710: {//Summer Robin
            captain: "Aumenta el ATK y el RCV de los personajes Cerebral 1.2x",
            special: "Incrementa la efectividad de los orbes para personajes Cerebral 1.75x 1 turno y reduce el daño recibido un 30% 2 turnos",
            specialName: "Charmed by a Lovely Adult",
            sailor: "Reduce la duración de la Ceguera 2 turnos",
        },
        1711: {//Summer Robin
            captain: "Aumenta el RCV de los personajes Cerebral 1.2x y aumenta el ATK 3x si tiene orbe favorable, si no 1.5x",
            special: "Incrementa la efectividad de los orbes para personajes Cerebral 1.75x 1 turno y reduce el daño recibido un 30% 2 turnos",
            specialName: "Charmed by a Lovely Adult",
            sailor: "Reduce la duración de la Ceguera 2 turnos",
        },
        1712: {//Akainu
        captain: "Aumenta el ATK de los personajes Driven 2.5x.",
        special: "Hace su ATK 50x como daño sin tipo a todos los enemigos. Incrementa la efectividad de los orbes para personajes Driven 2x durante 1 turno.",
        specialName: "Blazing Hound Crimson Lotus",
        },
        1713: {//Akainu
            captain: "Aumenta el ATK de los personajes Driven 2.5x. Si derrotas a un enemigo, aumenta la potenciación del ATK ligeramente. Éste aumentará un máximo de 3 veces hata un multiplicador de  3.25x. como límite",
            captainNotes: "Si no se derrota a ningún enemigo, dicho aumento de ATK se perderá y volverá a ser 2.5x.",
            special: "Hace su ATK 50x como daño sin tipo a todos los enemigos. Incrementa la efectividad de los orbes para personajes Driven 2x durante 1 turno.",
            specialName: "Blazing Hound Crimson Lotus",
        },
        1714: {//Monet
            captain: "Aumenta el ATK de los personajes INT 2x. Recupera una cantidad equivalente de HP a su RCV 2x al final de cada turno",
            special: "Hace su ATK 10x como daño [INT] a todos los enemigos. Aleatoriza todos los orbes a [TND], [BOMB] o [RCV] .",
            specialName: "Devouring Blizzard",
        },
        1715: {//Vergo
            captain: "Aumenta el ATK de los personajes Striker 2.5x si tienen orbe favorable, 2x si no tienen",
            special: "Cambia su propio orbe a [QCK], fija los orbes durante 1 turno",
